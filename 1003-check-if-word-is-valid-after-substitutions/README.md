<h2><a href="https://leetcode.com/problems/check-if-word-is-valid-after-substitutions/?envType=problem-list-v2&envId=stack">1045. Check If Word Is Valid After Substitutions</a></h2><h3>Medium</h3><hr><p>Given a string <code>s</code>, determine if it is <strong>valid</strong>.</p>
